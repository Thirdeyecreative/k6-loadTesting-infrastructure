...
// Retrieve configuration injected by the Python orchestrator
...
// Construct the full target URL and append any query parameters
...
// Define execution profiles for different test types
const profiles = {
...
// Export test options and merge global safety thresholds with project-specific rules
...
// Main execution logic for a single Virtual User iteration
export default function () {
  ...
  // Serialize payload based on content type (JSON vs Form Data)
...
// Generate report files (CSV, JSON, HTML, XML) at the end of the test
...
// Helper to convert k6 metrics JSON to flat CSV format
